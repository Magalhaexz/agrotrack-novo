...
export const CATALOGO_INTENCOES = {
  ...
  [INTENCOES.EDITAR_PESAGEM]: { tipo: 'cadastro', exemplos: ['corrija a pesagem do lote Recria para 405 kg'] },
  [INTENCOES.EXCLUIR_PESAGEM]: { tipo: 'cadastro', exemplos: ['excluir a última pesagem do lote Recria'] },
  [INTENCOES.AJUSTAR_LOTACAO]: { tipo: 'cadastro', exemplos: ['ajuste o lote Recria para 28 cabeças'] },
  [INTENCOES.EDITAR_LOTE]: { tipo: 'cadastro', exemplos: ['altere o sexo do lote Recria para fêmeas'] },
  [INTENCOES.EDITAR_PASTO]: { tipo: 'cadastro', exemplos: ['edite o pasto Norte, área 25 hectares'] },
  [INTENCOES.RETIRAR_LOTE_PASTO]: { tipo: 'cadastro', exemplos: ['retire o lote Recria do pasto atual'] },
  // Sprint Paridade 1, bloco 5 — alertas, exclusão de fazenda/pasto, resumo:
  [INTENCOES.MARCAR_ALERTA_EM_ANALISE]: { tipo: 'cadastro', exemplos: ['marque o alerta 2 como em análise'] },
  [INTENCOES.RESOLVER_ALERTA]: { tipo: 'cadastro', exemplos: ['resolver alerta 3', 'resolva o alerta de vacinação'] },
  [INTENCOES.IGNORAR_ALERTA]: { tipo: 'cadastro', exemplos: ['ignorar alerta 1'] },
  [INTENCOES.ADIAR_ALERTA]: { tipo: 'cadastro', exemplos: ['adiar alerta 2 até 30/07'] },
  [INTENCOES.REABRIR_ALERTA]: { tipo: 'cadastro', exemplos: ['reabrir o alerta de vacinação'] },
  [INTENCOES.RESUMO_CONSOLIDADO_FAZENDAS]: { tipo: 'consulta', exemplos: ['resumo de todas as fazendas', 'resumo consolidado'] },
  [INTENCOES.EXCLUIR_FAZENDA]: { tipo: 'cadastro', exemplos: ['excluir a fazenda Boa Esperança'] },
  [INTENCOES.EXCLUIR_PASTO]: { tipo: 'cadastro', exemplos: ['excluir o pasto Norte'] },
